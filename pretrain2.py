...
testb_data = pd.read_csv('./submit_b/results_7628.csv')
testb_data = testb_data[testb_data['label'] != 0]
df = pd.concat([goods_data, query_data, test_data, testb_data], axis=0)
